...
Archivo .gitignore: Antes de subir nada, asegúrate de tener un archivo llamado .gitignore en tu carpeta. Este archivo le dice a Git qué NO subir (como contraseñas, carpetas pesadas como node_modules, archivos temporales, etc.). Si no lo tienes, puedes crear uno en gitignore.io seleccionando tu lenguaje de programación.
